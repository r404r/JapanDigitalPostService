...
// AddressRepo 用 database/sql 实现 domain.AddressRepository。
//
...
// NewAddressRepo 包装一个已打开的 *sql.DB。
...
func (r *AddressRepo) Search(ctx context.Context, q domain.AddressQuery) ([]domain.Address, int, error) {
...
// CountAll 返回地址总行数。
func (r *AddressRepo) CountAll(ctx context.Context) (int, error) {
	var n int
